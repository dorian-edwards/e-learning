...
const Heading = () => (
  <div className='heading-card mx-auto flex flex-col tablet:items-start items-center tablet:mx-0 tablet:pt-[163px] tablet:pl-4 tablet:pr-[100px] desktop:pr-[150px] pt-[102px] flex-[1_1_60%] px-4'>
