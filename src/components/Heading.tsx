...
const Heading = () => (
  <div className='heading-card w-[95%] max-w-[600px] mx-auto mb-[46px] flex flex-col items-center tablet:w-[50%] tablet:max-w-none tablet:mx-0 tablet:pt-[163px] pt-[102px]'>
